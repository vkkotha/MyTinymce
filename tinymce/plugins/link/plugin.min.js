			...
			return function (data) {
				editor.undoManager.transact(function () {
					...
					var linkAttrs = {
						...
						style: 'color: #000000; font-weight: inherit; background: none; text-decoration: none;'
		...
		var showDialog = function (editor, linkList) {
			...
			var updateText = function () {
				if (!initialText && onlyText && !data.text) {
					if (this.parent().parent().find('#text')[0])
			...
			win = editor.windowManager.open({
				...
				onSubmit: function (e) {
					...
					if (href.trim().charAt(0) == '@' && href.indexOf('//') === -1 && href.indexOf('mailto:') === -1) {
